...
-- bài 1 
-- 2) Tạo view view_users_firstname hiển thị người dùng có họ "Nguyễn"
...
-- 4) Thêm một nhân viên mới họ "Nguyễn" và kiểm tra lại View
INSERT INTO users (username, full_name, gender, email, password, birthdate, hometown) 
VALUES ('nguyen_moi', 'Nguyễn Văn Mới', 'Nam', 'nguyenmoi@gmail.com', 'password123', '2000-01-01', 'Hà Nội');

-- Truy vấn lại view để kiểm tra (bạn sẽ thấy user 'nguyen_moi' xuất hiện)
SELECT * FROM view_users_firstname;

-- 5) Xóa nhân viên vừa thêm và kiểm tra lại View
DELETE FROM users 
WHERE username = 'nguyen_moi';

SELECT * FROM view_users_firstname;

-- bài 2 
-- 2) Tạo view view_user_post hiển thị user_id và tổng số bài viết
...
-- 3) Hiển thị lại view vừa tạo để kiểm chứng
