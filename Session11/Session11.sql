...
CALL CreatePostWithValidation(1, 'AnAn', @result_message);
SELECT @result_message;

CALL CreatePostWithValidation(1, 'Pham Lan Nhi', @result_message);
SELECT @result_message;
...
-- Bai 5 :
DELIMITER $$
CREATE PROCEDURE sp_calculate_user_activity_score (
    IN p_user_id INT,
...
CALL sp_calculate_user_activity_score(1, @activity_score, @activity_level);

SELECT @activity_score, @activity_level;

DROP PROCEDURE IF EXISTS sp_calculate_user_activity_score;
